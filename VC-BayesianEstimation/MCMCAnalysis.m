...
% The last two statements are added by Ren Zhang, 7/3/2018
...
% if isMakePlotsHistDecomp
%   Tests2Run{end+1} = 'MakePlotsHistDecomp';
% end

% if isMakePlotsForecast
%   Tests2Run{end+1} = 'MakePlotsForecast';
% end
